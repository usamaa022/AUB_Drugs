...
export default function TransportHistoryPage() {
  ...
  return (
    <div style={{ width: "100%", minHeight: "100vh", backgroundColor: "#f8fafc", padding: 0, margin: 0, boxSizing: "border-box", overflowX: "hidden" }}>
      <style>{`
      ...
      <div style={{ width: "100%", margin: 0, padding: 0, boxSizing: "border-box" }}>
        ...
        {user.role === "superAdmin" && (
          <div style={{ padding: "0 24px", marginBottom: "20px", width: "100%", boxSizing: "border-box" }}>
            <div className="card mb-6" style={{ width: "100%", boxSizing: "border-box" }}>
        ...
        <div style={{ padding: "0 24px", width: "100%", boxSizing: "border-box" }} className="space-y-6">
          ...
          {transports.length === 0 ? (
            <div className="empty-state" style={{ width: "100%", textAlign: "center", padding: "40px 0" }}>
            ...
            <div className="space-y-4" style={{ width: "100%" }}>
              {transports.map((transport) => (
                <div key={transport.id} className="card" style={{ width: "100%", boxSizing: "border-box", borderRadius: 0, borderLeft: "none", borderRight: "none" }}>
                  <div
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      <div>
                        ...
                        <div className="flex items-center space-x-2 mt-1" style={{ display: "flex", gap: "8px" }}>
                  ...
                  <AnimatePresence>
                    {selectedTransport?.id === transport.id && (
                      <motion.div
                        ...
                        style={{ width: "100%" }}
                      >
                        <div className="p-4 bg-gray-50 rounded-lg" style={{ width: "100%", boxSizing: "border-box" }}>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6" style={{ width: "100%" }}>
                          ...
                          <div style={{ width: "100%" }}>
                            ...
                            <div className="overflow-x-auto rounded-lg border border-gray-200" style={{ width: "100%" }}>
